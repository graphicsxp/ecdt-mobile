  ...
  plugins: [
    ...
    commonjs({
      namedExports: {
        ...
        '@progress/kendo-angular-charts/dist/npm/js/chart/value-axis-item/crosshair.component': ['ValueAxisCrosshairComponent'],
        '@progress/kendo-angular-charts/dist/npm/js/chart/value-axis-item/crosshair.tooltip.component': ['ValueAxisCrosshairTooltipComponent'],
        '@progress/kendo-angular-charts/dist/npm/js/chart/category-axis-item.component': ['CategoryAxisItemComponent'],
        '@progress/kendo-angular-charts/dist/npm/js/chart/category-axis-item/crosshair.component': ['CategoryAxisCrosshairComponent'],
        '@progress/kendo-angular-charts/dist/npm/js/chart/category-axis-item/crosshair.tooltip.component': ['CategoryAxisCrosshairTooltipComponent'],
        ...
        '@progress/kendo-angular-charts/dist/npm/js/chart/series-item/tooltip.component': ['SeriesTooltipComponent'],
